...
SIM_CACHE_DIR          = Path("game_xml_cache/sim_results")
...
def match_odds_to_espn(espn_games: list[dict], odds_games: list[dict]) -> list[dict]:
    ...
    for eg in espn_games:
        ea = _clean_school(eg["away_team"])
        eh = _clean_school(eg["home_team"])
        best_match, best_score = None, 0.0

        for og in odds_games:
            oa = _clean_school(og["away_team"])
            oh = _clean_school(og["home_team"])
...
# ── Mascot/noise words to strip before matching ───────────────────────────────
_MASCOT_WORDS = {
    "university","college","the","at","of","and","a",
    # mascots — the chief source of false matches
    "eagles","hawks","tigers","bears","wolves","bulldogs","panthers",
    "wildcats","cardinals","warriors","golden","flying","running","runnin",
    "fighting","blue","red","black","green","white","orange","crimson",
    "pioneers","buccaneers","flames","hatters","governors","huskies",
    "chippewas","broncos","rockets","quakers","spartans","rams","flyers",
    "hilltoppers","owls","mustangs","aggies","horned","frogs","knights",
    "mountaineers","mountaineer","cougars","bearcats","jaguars","stags",
    "pilots","boilermakers","hoosiers","badgers","hawkeyes","gophers",
    "nittany","lions","scarlet","terrapins","terps","hoyas","friars",
    "bluejays","musketeers","bulldawgs","razorbacks","commodores","gamecocks",
    "rebels","bulldawg","anteaters","roadrunners","matadors","49ers",
    "tritons","highlanders","lumberjacks","colonels","ospreys","stetson",
    "redhawks","bobcats","skyhawks","bisons","beacons","braves","racers",
    "panthers","paladins","citadel","bulldogs","redbirds","seawolves",
}

# ── ESPN abbreviation → StatBroadcast GID ─────────────────────────────────────
# Keyed on lowercase ESPN abbreviation. Source of truth — takes priority over
# name matching. Add rows here as new mismatches are found via --verify.
# GIDs confirmed from verify output 2026-03-07.
ESPN_ABBR_TO_GID: dict[str, str] = {
    # ACC
    "duke":"duke","unc":"unc","clem":"clem","bc":"bc","ncst":"ncst",
    "vt":"vtec","uva":"va","wake":"wake","pitt":"pitt","cuse":"syr",
    "miami":"mifl","gt":"geot","fsu":"fsu","nd":"nd","lou":"lou",
    "syr":"syr","ncsu":"ncst","stan":"stan","cal":"cal",
    # Big 12
    "kan":"kan","ku":"kan","ksu":"ksu","bay":"bay","tcu":"tcu","tex":"tex",
    "ttu":"text","wvu":"wvir","cin":"cinn","ucf":"ucf","iast":"iast",
    "isu":"iast","okst":"okst","okla":"okla","ou":"okla",
    "byu":"byu","utah":"utah","colo":"colo","az":"ariz","ariz":"ariz",
    "asu":"asu","hou":"hou",
    # Big Ten
    "msu":"msu","mich":"mich","osu":"osu","ind":"ind","iu":"ind",
    "pur":"pur","ill":"ill","minn":"minn","iowa":"iow","wis":"wisc",
    "nw":"nw","neb":"neb","md":"md","psu":"psu","rutg":"rutu",
    "ucla":"ucla","usc":"usc","ore":"ore","wsh":"wash","wash":"wash",
    "uga":"ugeo","nwst":"nwst","nist":"nist",
    # Big East
    "nova":"nova","vill":"nova","uconn":"conn","conn":"conn",
    "marq":"marq","depa":"depa","dep":"depa","prov":"prov","crei":"crei",
    "but":"but1","xav":"xavi","gtwn":"geot","sjun":"stjo",
    # SEC
    "sc":"scar","miss":"ole","miz":"missou",
    "uk":"kty","tam":"tam","ta&m":"tam","lsu":"lsu","aub":"aub",
    "ala":"alab","fla":"fla","tenn":"tenn","van":"vand","scar":"scar",
    "msst":"msst","ark":"ark","ole":"ole",
    # A-Sun
    "lip":"lips","fgcu":"fgcu","stet":"stet","apsu":"ausp","quc":"qunc",
    "bell":"bell","ken":"ken",
    # Big South / CAA / America East
    "win":"wint","chso":"cso","pres":"psby","rad":"rad",
    "hpu":"hpu","gard":"gard","camp":"camb","hamp":"hamp",
    "lngw":"lngw","unca":"unca","uncw":"uncw","ne":"ne",
    "drex":"drex","hofst":"hofs","del":"dela","towson":"tows",
    "tow":"tows","ualb":"albn","uml":"umlr","unh":"unhm","umbc":"umbc",
    "nu":"ne",
    # SoCon
    "chat":"chat","cit":"cit","vmi":"vmi","uncg":"uncg",
    "wof":"woff","woff":"woff","elon":"elon","mer":"merc","fur":"furm",
    "samf":"samf","sam":"samf","wcu":"wcar","etsu":"etsu",
    # MVC
    "brad":"brad","val":"valp","drke":"drak","belm":"belm",
    "uni":"uni","ilst":"ilst","evan":"evansv","most":"mosu","siu":"siu",
    "loy":"loyc","luc":"loyc",
    # MAC
    "akr":"akr","ni":"ni","bgsu":"bgsu","emu":"emu","kent":"kent",
    "wmu":"wmu","cmu":"cmu","ball":"ball","buff":"buff","tol":"tol",
    "m-oh":"mioh","ohio":"ohio",
    # A-10
    "dayt":"dayt","vcu":"vcu","duq":"duq","ford":"ford","gmu":"gema",
    "gw":"gwu","umass":"mass","uri":"rhod","rich":"rich",
    "las":"lass","joes":"sjoe","slu":"stlo","dav":"davi","sbu":"stbn",
    # MAAC
    "fair":"fair","stp":"stp","mrmk":"mrmk","iona":"iona",
    "manh":"manh","monk":"monk","niag":"niag","rider":"rider",
    "sie":"sien","mrst":"mari","quin":"quinnp",
    # OVC / ASUN
    "tnst":"tnst","utm":"utm","semo":"semo","morh":"more","more":"more",
    "murr":"murr","uic":"ilch","jkst":"jkst","shsu":"samh","lib":"libe",
    # Summit / Horizon
    "oma":"oma","sdak":"sdak","ndak":"ndak","denv":"denv",
    "ndsu":"ndsu","kenn":"kenn",
    # Ivy
    "harv":"harv","penn":"penn","colu":"colu","brow":"brow",
    "cor":"corn","corn":"corn","dart":"dart","yale":"yale","prin":"prin",
    # Sun Belt
    "txst":"txst","usm":"smis","usa":"usa","gso":"gsou","gsou":"gsou",
    "app":"appa","troy":"troy","arst":"arst","ulm":"ulm","ccar":"ccar",
    "ccu":"ccu","gaso":"geos","mtsu":"mtsu",
    # WCC / WAC / West
    "gonz":"gonz","sdsu":"sdsu","unlv":"unlv","fres":"fres",
    "port":"port","sea":"seatu","seu":"seatu","sf":"sanf",
    "sdieg":"sdieg","pac":"pacif","gcu":"grca",
    # CUSA / Conference USA
    "ncat":"ncat","nccu":"nccu","wgeo":"wgeo","ltec":"latc","lt":"latc",
    "utep":"utep","fau":"fau","wich":"wich","wku":"wkyu","fiu":"fiu",
    "nmst":"nmst","nmsu":"nmst","jxst":"jkst",
    # Mountain West
    "unm":"nm","usu":"ust","bois":"bosu","csu":"colst","wyo":"wyom",
    "sjsu":"sjsu","af":"afa","nev":"unv","afa":"afa",
    # Big West
    "ucd":"ucda","uci":"ucir","ucsb":"ucsb","ucsd":"ucsd","lbsu":"lbst",
    "haw":"haw","csuf":"csuf","csun":"csun","csub":"csub","cp":"cslop",
    # AE / Southern / Southland / others
    "smu":"smu","me":"maine","njit":"njit","achr":"acu","acu":"acu",
    "nau":"naz","idst":"idst","uta":"txar","und":"ndak","uvm":"verm",
    "bry":"bry","wag":"wagn","liu":"liu","stmn":"sttm",
    "sac":"csac","idho":"idho","uvu":"utva","utu":"uttu","suu":"suta",
    "cbu":"calb","gmu":"gema","w&m":"wima","msm":"mtsm",
}

# ── Full ESPN display name → StatBroadcast GID ────────────────────────────────
# School name (lowercase, mascot stripped) → GID.
# This is the fallback when abbreviation lookup fails.
ESPN_NAME_TO_GID: dict[str, str] = {
    # MVC
    "drake":"drak","belmont":"belm","valparaiso":"valp","bradley":"brad",
    "northern iowa":"uni","illinois state":"ilst","evansville":"evansv",
    "missouri state":"most","southern illinois":"siu","loyola chicago":"loychi",
    # A-Sun
    "lipscomb":"lips","stetson":"stet","austin peay":"apsu",
    "florida gulf coast":"fgcu","njit":"njit","kennesaw state":"ken",
    "queens university":"quc","bellarmine":"bellar","central arkansas":"cark",
    # Big South / CAA / NEC
    "winthrop":"wint","charleston southern":"cso","presbyterian":"pres",
    "radford":"rad","high point":"hpu","gardner-webb":"gard","gardner webb":"gard",
    "campbell":"camp","hampton":"hamp","longwood":"lngw",
    "unc asheville":"unca","unc wilmington":"uncw","northeastern":"ne",
    "sacred heart":"shun","merrimack":"mrmk",
    # SoCon
    "chattanooga":"chat","the citadel":"cit","vmi":"vmi",
    "unc greensboro":"uncg","wofford":"woff","elon":"elon",
    "mercer":"mery","furman":"fur","samford":"sams",
    # MAC
    "akron":"akr","northern illinois":"ni","bowling green":"bgsu",
    "eastern michigan":"emu","kent state":"kent","western michigan":"wmu",
    "central michigan":"cmu","ball state":"ball","buffalo":"buff",
    "toledo":"tol","miami ohio":"mioh","miami (oh)":"mioh","ohio":"ohio",
    # A-10
    "dayton":"dayt","vcu":"vcu","duquesne":"duq","fordham":"ford",
    "george mason":"gmas","george washington":"gwu","umass":"mass",
    "rhode island":"rhod","richmond":"rich",
    # MAAC
    "fairfield":"fair","saint peter s":"stp","saint peter":"stp",
    "merrimack":"mrmk","iona":"iona","manhattan":"manh","monmouth":"monk",
    "niagara":"niag","rider":"rider","siena":"siena",
    # OVC
    "tennessee state":"tnst","ut martin":"utm","southeast missouri state":"semo",
    "morehead state":"morh","murray state":"murr","uic":"uic",
    # Summit
    "omaha":"oma","south dakota":"sdak","north dakota":"ndak","denver":"denv",
    # Ivy
    "harvard":"harv","pennsylvania":"penn","columbia":"colu","brown":"brow",
    "cornell":"corn","dartmouth":"dart","yale":"yale","princeton":"prin",
    # Sun Belt
    "texas state":"txst","southern miss":"smiss","south alabama":"usa",
    "georgia southern":"gsou","appalachian state":"app","troy":"troy",
    "arkansas state":"arst","louisiana monroe":"ulm","coastal carolina":"ccar",
    # WCC / WAC
    "gonzaga":"gonz","san diego state":"sdsu","unlv":"unlv","fresno state":"fres",
    "portland":"port","seattle":"seatu","san diego":"sdieg",
    # CUSA / misc
    "north carolina a&t":"ncat","nc a&t":"ncat","ncat":"ncat",
    "north carolina central":"nccu","west georgia":"wgeo",
    "west virginia":"wvir","georgia tech":"geot",
    # Big Ten
    "michigan":"mich","michigan state":"msu","ohio state":"osu",
    "indiana":"ind","purdue":"pur","illinois":"ill","minnesota":"minn",
    "iowa":"iowa","wisconsin":"wisc","northwestern":"nw","nebraska":"neb",
    "maryland":"md","penn state":"psu","rutgers":"rutu",
    "ucla":"ucla","usc":"usc","oregon":"ore","washington":"wash",
}


def _clean_school(s: str) -> str:
    """Strip mascots and noise words, return only school-name tokens."""
    s = s.lower()
    s = re.sub(r"[^a-z0-9 ]", " ", s)
    tokens = [t for t in s.split() if t not in _MASCOT_WORDS and len(t) > 1]
    return " ".join(tokens)
...
def gid_to_full_name(gid: str, known_gids) -> str:
    if gid in _GID_NAME_CACHE:
        return _GID_NAME_CACHE[gid]
    name = known_gids.get(gid, gid) if isinstance(known_gids, dict) else gid
...
def find_game(games: list[dict], visitor_gid: str, home_gid: str,
    ...
    vis_clean  = _clean_school(visitor_gid)
    home_clean = _clean_school(home_gid)

    def matches(query: str, team_name: str) -> bool:
        t = _clean_school(team_name)
    ...
    for game in games:
        if matches(vis_clean, game["away_team"]) and \
           matches(home_clean, game["home_team"]):
            return game
    return None
...
def odds_team_to_gid(team_name: str, known_gids: list[str],
    ...
    """
    Map a team name or ESPN abbreviation → StatBroadcast GID.

    Resolution order (stops at first hit):
      1. ESPN_ABBR_TO_GID  — hardcoded abbreviation table (most reliable)
      2. ESPN_NAME_TO_GID  — hardcoded school-name table
      3. Persistent user-confirmed cache (only written on interactive pick)
      4. Interactive prompt — never auto-saves fuzzy guesses

    Fuzzy auto-matching is intentionally disabled — it produces too many false
    positives (e.g. "eagles" or "ne" matching wrong teams). All unknowns go to
    the interactive prompt or are skipped. When you confirm a team, the script
    prints the line to add to ESPN_ABBR_TO_GID so it never prompts again.
    """
    key = team_name.strip().lower()

    # 1. Abbreviation table
    if key in ESPN_ABBR_TO_GID:
        gid = ESPN_ABBR_TO_GID[key]
        if gid in known_gids:
            return gid

    # 2. School-name table — try exact key, then mascot-stripped version
    school = _clean_school(team_name)
    for lookup in [key, school]:
        if lookup in ESPN_NAME_TO_GID:
            gid = ESPN_NAME_TO_GID[lookup]
            if gid in known_gids:
                return gid

    # 3. Confirmed user cache (written only via interactive prompt below)
    cache = _load_name_gid_cache()
    if key in cache:
        gid = cache[key]
        if gid in known_gids:
            return gid
        log.warning(f"  Stale cache entry '{key}' → '{gid}' (not in known GIDs), removing")
        del cache[key]
        _save_name_gid_cache(cache)

    # 4. Interactive prompt
    if not interactive:
        log.debug(f"  No mapping for '{team_name}' (key='{key}') — skipping")
        return None

    # Score candidates by character overlap only — avoids mascot word noise
    key_chars = set(key.replace(" ", ""))
    scored = []
    for gid in known_gids:
        gid_chars = set(gid)
        if not key_chars or not gid_chars:
            continue
        overlap = len(key_chars & gid_chars) / max(len(key_chars), len(gid_chars))
        if gid in school or school.startswith(gid):
            overlap = min(1.0, overlap + 0.3)
        scored.append((overlap, gid))
    scored.sort(reverse=True)
    top = scored[:8]

    print(f"\n  ❓ No mapping for ESPN team: '{team_name}'  (key: '{key}')")
    print(f"     Top StatBroadcast GID candidates:")
    for i, (score, gid) in enumerate(top, 1):
        print(f"       {i}. {gid:<20}  ({score:.0%} char overlap)")
    print(f"       s. Skip")
    print(f"       t. Type a GID manually")
    print(f"     💡 To avoid this prompt, add to ESPN_ABBR_TO_GID: \"{key}\":\"<gid>\"")

    while True:
        choice = input("  Select [1-8 / s / t]: ").strip().lower()
        if choice == "s":
            return None
        if choice == "t":
            manual = input("  Enter GID: ").strip().lower()
            if manual in known_gids:
                cache[key] = manual
                _save_name_gid_cache(cache)
                print(f"  ✅ Saved. Add to ESPN_ABBR_TO_GID: \"{key}\":\"{manual}\"")
                return manual
            print(f"  '{manual}' not in known GIDs. Try --list-gids to browse.")
        elif choice.isdigit() and 1 <= int(choice) <= len(top):
            chosen = top[int(choice) - 1][1]
            cache[key] = chosen
            _save_name_gid_cache(cache)
            print(f"  ✅ Saved. Add to ESPN_ABBR_TO_GID: \"{key}\":\"{chosen}\"")
            return chosen
        else:
...
def blend_team_matrices(
    ...
    """
    Accumulate weighted raw transition COUNTS from a team's recent games.
    Returns counts (not probabilities) so they can be combined before normalizing.

    Games assumed most-recent first.
    """
    ...
    return accumulated, avg_poss, vis_name, home_name
...
def build_matchup_matrix(
    ...
    """
    Build a single matchup transition matrix from two teams' raw count matrices.

    Key insight: each game XML already contains transitions for BOTH teams
    (V_* and H_* states). So vis_counts has real data for all 14 states, and
    so does home_counts. We blend them by:
      - V_* rows (states 0-6): use visitor team's counts — their offensive/
        defensive tendencies when they are the acting team
      - H_* rows (states 7-13): use home team's counts

    This preserves each team's actual tendencies in their respective half of
    the state space, rather than diluting by a simple average.
    """
    N  = N_STATES
    half = N // 2   # 7
    P = np.zeros((N, N), dtype=np.float64)

    # V_* rows from visitor's games, H_* rows from home's games
    P[:half, :] = vis_counts[:half, :]
    P[half:, :] = home_counts[half:, :]

    return counts_to_prob(P)
...
def combine_visitor_home_matrices(
    ...
    """Legacy shim — use build_matchup_matrix(counts_vis, counts_home) instead."""
...
def _run_chain(P: np.ndarray, n_sim: int, n_steps: int,
    ...
    Runs n_sim independent chains for n_steps transitions each.
    Both teams' scores are accumulated from the same chain — visitor and home
    points are determined by which state each transition lands in, so their
    scoring is naturally correlated (when visitor is scoring, home isn't).

    Returns
    -------
    v_scores : (n_sim,) int32 — visitor total points
    h_scores : (n_sim,) int32 — home total points
    """
    P_cum    = np.cumsum(P, axis=1)
    draws    = rng.random((n_steps, n_sim))
    states   = rng.integers(0, N_STATES, size=n_sim)
    v_scores = np.zeros(n_sim, dtype=np.int32)
    h_scores = np.zeros(n_sim, dtype=np.int32)

    for step in range(n_steps):
        states    = (draws[step, :, np.newaxis] > P_cum[states]).sum(axis=1)
        states    = np.clip(states, 0, N_STATES - 1)
        v_scores += V_PTS[states]
        h_scores += H_PTS[states]

    return v_scores, h_scores
...
def run_simulation(P: np.ndarray, n_sim: int = 50_000,
    ...
    A single Markov chain is stepped n_possessions times per simulation.
    Both teams' scores accumulate from the same chain so their totals are
    properly correlated — visitor scoring and home scoring are mutually
    exclusive on each step (as in real basketball).
    """
    rng = np.random.default_rng(seed)
    v_scores, h_scores = _run_chain(P, n_sim, n_possessions, rng)

    avg_total = float((v_scores + h_scores).mean())
    if avg_total < 80:
        log.warning(
            f"Avg simulated total is {avg_total:.1f} — suspiciously low. "
            f"n_possessions={n_possessions}. Check transition matrix."
        )
    elif avg_total > 220:
        log.warning(
            f"Avg simulated total is {avg_total:.1f} — suspiciously high. "
            f"n_possessions={n_possessions}. Check transition matrix."
        )

    spread = v_scores - h_scores
    totals = v_scores + h_scores
    v_wins = int((v_scores > h_scores).sum())
    h_wins = int((h_scores > v_scores).sum())
    ...
    return {
        ...
        "avg_visitor":     float(v_scores.mean()),
        "avg_home":        float(h_scores.mean()),
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--lookup", action="store_true",
                   help="Find a future game on the Odds API and simulate it. "
                        "Use with --visitor and --home, e.g.: "
                        "--lookup --visitor duke --home unc --odds-api-key $KEY")
    p.add_argument("--verify", action="store_true",
                   help="Print ESPN→GID mapping table and exit without simulating")
    p.add_argument("--load", action="store_true",
                   help="Load and display cached parquet results instead of re-simulating")
    p.add_argument("--min-edge", type=float, default=0.0,
                   help="Only show bets with edge above this threshold, e.g. 0.05 = 5%%")
    p.add_argument("--bankroll", type=float, default=100.0,
                   help="Starting bankroll for sequential Kelly sizing (default: 100)")
    p.add_argument("--sequential-kelly", action="store_true",
                   help="Show sequential Kelly bet sizes: each bet reduces bankroll before next")
...
def simulate_game_for_screen(
    ...
    P_vis_counts,  avg_poss_vis,  vis_xml_name,  _            = blend_team_matrices(vis_xmls,  weighting)
    P_home_counts, avg_poss_home, home_xml_name, home_xml_name2 = blend_team_matrices(home_xmls, weighting)

    # Sanity check: warn if XML team names look wrong for the GIDs we requested
    log.info(f"  [{game_label or f'{vg}@{hg}'}] "
             f"vis XML='{vis_xml_name}' (gid={vg}) | "
             f"home XML='{home_xml_name}' (gid={hg})")

    P_match  = build_matchup_matrix(P_vis_counts, P_home_counts)
    n_poss   = int((avg_poss_vis + avg_poss_home) / 2) or 150
    res      = run_simulation(P_match, n_sim=nsim, n_possessions=n_poss)
    log.info(f"  [{game_label or f'{vg}@{hg}'}] "
             f"sim: V={res['avg_visitor']:.1f} H={res['avg_home']:.1f} "
             f"total={res['avg_total']:.1f} Vwin={res['visitor_win_pct']*100:.1f}%")
...
# ═══════════════════════════════════════════════════════════════════════════════
# PARQUET CACHE  —  save/load/display sim results
# ═══════════════════════════════════════════════════════════════════════════════

def _parquet_path(date: str) -> Path:
    SIM_CACHE_DIR.mkdir(parents=True, exist_ok=True)
    return SIM_CACHE_DIR / f"{date}.parquet"


def save_results_parquet(bets: list[dict], date: str) -> Path:
    """Serialize all bet dicts to a parquet file. Returns the path written."""
    if not HAS_POLARS:
        log.warning("polars not installed — skipping parquet save. "
    ...
    # Only positive-edge bets, then deduplicate to best side per game+market
    positive = [b for b in bets
                if b.get("book_implied", 0) > 0 and b.get("edge", 0) > 0]
    seen: dict[str, dict] = {}
    for b in positive:
        key = f"{b['game']}|{b['market']}"
        if key not in seen or b["edge"] > seen[key]["edge"]:
            seen[key] = b
    deduped = sorted(seen.values(), key=lambda b: b["edge"], reverse=True)
    ...
    new_df = pl.DataFrame([{
        ...
        "book_implied": float(b["book_implied"]),
        "edge":         float(b["edge"]),
        "kelly":        float(b["kelly"]),
        "odds":         float(b.get("odds") or 0),
    } for b in deduped])

    # Merge with existing parquet if present — new run wins on conflict
    if path.exists():
        existing = pl.read_parquet(path)
        combined = pl.concat([existing, new_df])
        # Deduplicate: keep the new row when game+market conflicts
        df = (combined
              .with_row_index("_row")
              .sort("_row", descending=True)          # new rows first
              .unique(subset=["game", "market"], keep="first")
              .drop("_row")
              .sort("edge", descending=True))
        n_new     = len(new_df)
        n_kept    = len(df) - (len(existing) - combined.filter(
            pl.struct("game","market").is_in(
                new_df.select(["game","market"])
            )).shape[0])
        log.info(f"Merged {n_new} new bets into existing {len(existing)}-row parquet "
                 f"→ {len(df)} total rows")
    else:
        df = new_df
        log.info(f"Created new parquet with {len(df)} bets")

    df.write_parquet(path)
    log.info(f"Saved {len(df)} bets → {path}")
    return path


def load_results_parquet(date: str) -> "pl.DataFrame | None":
    """Load a previously saved parquet for a given date. Returns None if not found."""
    if not HAS_POLARS:
        log.warning("polars not installed — cannot load parquet.")
        return None
    path = _parquet_path(date)
    if not path.exists():
        return None
    df = pl.read_parquet(path)
    log.info(f"Loaded {len(df)} bets from {path}")
    return df


def display_results(df: "pl.DataFrame", args) -> None:
    """
    Filter and display a polars DataFrame of bet results.

    Respects --markets, --sort, --top, --min-edge flags.
    Uses full school names from away_team/home_team columns.
    """
    if not HAS_POLARS:
        return

    # Filter markets
    if args.markets and args.markets != ["ml", "spread", "total"]:
        market_map = {"ml": "ML", "spread": "Spread", "total": "Total"}
        allowed = [market_map[m] for m in args.markets if m in market_map]
        df = df.filter(pl.col("market").is_in(allowed))

    # Filter min edge
    min_edge = getattr(args, "min_edge", 0.0) or 0.0
    df = df.filter(pl.col("edge") > min_edge)

    # Sort
    if args.sort == "time":
        df = df.sort("game_time")
    else:
    ...
    SEP = "═" * 100
    print(f"\n{SEP}")
    print(f"  {'#':<4} {'Away':<22} {'Home':<22} {'Time':<8} "
          f"{'Mkt':<8} {'Side':<24} {'Model':>7} {'Book':>7} {'Edge':>7} {'Kelly':>8}")
    print(f"  {'─'*3} {'─'*21} {'─'*21} {'─'*7} "
          f"{'─'*7} {'─'*23} {'─'*7} {'─'*7} {'─'*7} {'─'*8}")

    for i, row in enumerate(df.iter_rows(named=True), 1):
        away = row["away_team"] or row["game"].split(" @ ")[0] if " @ " in row["game"] else ""
        home = row["home_team"] or row["game"].split(" @ ")[1] if " @ " in row["game"] else ""
        t    = row["game_time"][:16].replace("T", " ")[11:16] if row["game_time"] else ""  # HH:MM UTC
        print(f"  {i:<4} {away[:21]:<22} {home[:21]:<22} {t:<8} "
              f"{row['market']:<8} {row['side'][:23]:<24} "
              f"{row['model_prob']*100:>6.1f}% "
              f"{row['book_implied']*100:>6.1f}% "
              f"{row['edge']*100:>+6.1f}% "
              f"{row['kelly']*100:>7.2f}%")

    print(SEP)
    print(f"\n  Kelly % = fraction of bankroll at {getattr(args, 'kelly', 1.0)}x Kelly")
    print(f"  Parquet: {_parquet_path(getattr(args, 'date', None) or str(__import__('datetime').date.today()))}\n")

    # Optional sequential Kelly table
    if getattr(args, "sequential_kelly", False):
        bankroll  = getattr(args, "bankroll", 100.0)
        start     = bankroll
        rows      = df.head(args.top).filter(pl.col("edge") > (getattr(args, "min_edge", 0) or 0))
        print(f"\n  SEQUENTIAL KELLY SIZING  —  starting bankroll: ${start:.2f}")
        print(f"  {'#':<4} {'Away':<20} {'Home':<20} {'Side':<22} "
              f"{'Edge':>7} {'Kelly':>7} {'From':>9} {'Bet $':>8} {'Left':>9}")
        print(f"  {'─'*3} {'─'*19} {'─'*19} {'─'*21} "
              f"{'─'*7} {'─'*7} {'─'*9} {'─'*8} {'─'*9}")
        total_bet = 0.0
        for i, row in enumerate(rows.iter_rows(named=True), 1):
            bet = bankroll * row["kelly"]
            away = row["away_team"] or ""
            home = row["home_team"] or ""
            print(f"  {i:<4} {away[:19]:<20} {home[:19]:<20} {row['side'][:21]:<22} "
                  f"{row['edge']*100:>+6.1f}% {row['kelly']*100:>6.1f}%  "
                  f"${bankroll:>8.2f}  ${bet:>7.2f}  ${bankroll-bet:>8.2f}")
            total_bet += bet
            bankroll  -= bet
        print(f"\n  Total bet: ${total_bet:.2f}   Unbet: ${bankroll:.2f}   "
              f"({total_bet/start*100:.1f}% of bankroll deployed)\n")
...
def run_screen(args) -> None:
    ...
    # ── Step 4b: --verify mode — print GID mapping table and exit ────────────
    if getattr(args, 'verify', False):
        print(f"\n{'ESPN Away':<28} {'→ GID':<12} {'ESPN Home':<28} {'→ GID':<12}  {'Lines?'}")
        print(f"{'─'*27} {'─'*11} {'─'*27} {'─'*11}  {'─'*6}")
        for eg, vg, hg in resolved:
            has_lines = "✓" if eg["odds"] else "—"
            print(f"{eg['away_team']:<28} {vg:<12} {eg['home_team']:<28} {hg:<12}  {has_lines}")
        if skipped:
            print(f"\n  {skipped} games skipped (GID not resolved):")
            for eg in espn_games:
                away_abbr = eg.get("away_abbr", "").lower()
                home_abbr = eg.get("home_abbr", "").lower()
                vg = (odds_team_to_gid(away_abbr, known_gids, interactive=False)
                      or odds_team_to_gid(eg["away_team"], known_gids, interactive=False))
                hg = (odds_team_to_gid(home_abbr, known_gids, interactive=False)
                      or odds_team_to_gid(eg["home_team"], known_gids, interactive=False))
                if not vg or not hg:
                    print(f"    {eg['away_team']:<28} (gid={vg or '?'})  @  "
                          f"{eg['home_team']:<28} (gid={hg or '?'})")
        print(f"\n  Add missing mappings to game_xml_cache/name_to_gid.json then re-run.")
        return
    ...
    def process_game(eg, vis_gid, home_gid):
        ...
        for b in bets:
            ...
            b["away_team"]  = eg["away_team"]   # full ESPN display name
            b["home_team"]  = eg["home_team"]
        return bets
    ...
    # ── Step 6: Save parquet ──────────────────────────────────────────────────
    parquet_path = save_results_parquet(all_bets, target_date)

    # ── Step 7: Load and display ──────────────────────────────────────────────
    if HAS_POLARS and parquet_path:
        df = load_results_parquet(target_date)
        positive_count = (df["edge"] > 0).sum() if df is not None else 0
        print(f"\n{'═'*100}")
        print(f"  DAILY SCREENER  —  {target_date}  [sorted by {args.sort}]")
        print(f"  {len(espn_games)} ESPN games  |  {len(odds_games)} with book lines  "
              f"|  {skipped} skipped  |  {positive_count} positive-edge bets")
        print(f"  Showing top {args.top}  |  parquet: {parquet_path}")
        display_results(df, args)
    else:
        # Fallback plain display if polars not available
        ...
        for i, b in enumerate(ranked[:args.top], 1):
            away = b.get("away_team", b["game"].split(" @ ")[0])
            home = b.get("home_team", b["game"].split(" @ ")[-1])
            t = b.get("game_time", "")[:16].replace("T", " ")[11:16] if b.get("game_time") else ""
            print(f"  {i:<4} {away[:21]:<22} {home[:21]:<22} {t:<8} "
                  f"{b['market']:<8} {b['side'][:23]:<24} "
...
def main() -> None:
    ...
    # ── Screen mode ──────────────────────────────────────────────────────────
    if args.screen:
        # --load: skip simulation, just re-display cached parquet
        if getattr(args, "load", False):
            from datetime import date as _date
            target_date = args.date or str(_date.today())
            if not HAS_POLARS:
                raise SystemExit("--load requires polars: pip install polars pyarrow")
            df = load_results_parquet(target_date)
            if df is None:
                raise SystemExit(
                    f"No cached results for {target_date}. "
                    f"Run without --load first to simulate."
                )
            positive_count = (df["edge"] > 0).sum()
            print(f"\n{'═'*100}")
            print(f"  CACHED RESULTS  —  {target_date}  [sorted by {args.sort}]")
            print(f"  {len(df)} total bets cached  |  {positive_count} positive-edge")
            print(f"  Showing top {args.top}  |  markets: {args.markets}")
            display_results(df, args)
            return
        run_screen(args)
        return

    # ── Lookup mode — find a future game and simulate it ─────────────────────
    if getattr(args, "lookup", False):
        if not args.visitor or not args.home:
            raise SystemExit("--lookup requires --visitor and --home")
        if not args.odds_api_key:
            raise SystemExit("--lookup requires --odds-api-key")

        known_gids = load_or_scrape_gids()
        vis_gid  = resolve_gid(args.visitor, known_gids)
        home_gid = resolve_gid(args.home,    known_gids)

        # Fetch all upcoming NCAAB games (no date filter = everything posted)
        log.info("Fetching all upcoming NCAAB lines from The Odds API …")
        params = {
            "apiKey":     args.odds_api_key,
            "regions":    "us",
            "markets":    "h2h,spreads,totals",
        ...
        all_games = resp.json()
        remaining = resp.headers.get("x-requests-remaining", "?")
        log.info(f"  {len(all_games)} upcoming games found  (requests remaining: {remaining})")

        game = find_game(all_games, vis_gid, home_gid)
        if not game:
            # Show closest matches to help user debug abbr
            print(f"\n  ⚠️  No odds found for {vis_gid} @ {home_gid}")
            print(f"  Upcoming games containing '{args.visitor}' or '{args.home}':")
            for g in all_games:
                ht = g.get("home_team","").lower()
                at = g.get("away_team","").lower()
                if (args.visitor.lower() in ht or args.visitor.lower() in at or
                    args.home.lower()    in ht or args.home.lower()    in at):
                    t = g.get("commence_time","")[:16].replace("T"," ")
                    print(f"    {t}  {g['away_team']} @ {g['home_team']}")
            print(f"\n  If the game isn't listed, lines may not be posted yet.")
            return

        lines     = extract_lines(game, preferred_book=args.book)
        game_time = game.get("commence_time","")[:16].replace("T"," ")
        vis_disp  = vis_gid.upper()
        home_disp = home_gid.upper()

        print(f"\n  Found: {game['away_team']} @ {game['home_team']}  —  {game_time} UTC")
        print_fetched_lines(lines, vis_disp, home_disp)

        # Simulate using cached XMLs
        xml_cache = Path(args.xml_dir) if args.xml_dir else Path("game_xml_cache")
        vis_xmls  = _load_xmls(vis_gid,  args.n_games, xml_cache)
        home_xmls = _load_xmls(home_gid, args.n_games, xml_cache)

        if not vis_xmls or not home_xmls:
            raise SystemExit(f"Could not load XMLs for {vis_gid} or {home_gid} — "
                             "check StatBroadcast GID with --list-gids")

        P_vis,  avg_poss_vis,  _, _ = blend_team_matrices(vis_xmls,  args.weighting)
        P_home, avg_poss_home, _, _ = blend_team_matrices(home_xmls, args.weighting)
        P_match  = build_matchup_matrix(P_vis, P_home)
        n_poss   = int((avg_poss_vis + avg_poss_home) / 2) or 150

        res = run_simulation(P_match, n_sim=args.nsim, n_possessions=n_poss)
        print_simulation_summary(res, vis_disp, home_disp)

        # Print all markets with edges
        kelly = args.kelly or 1.0
        bets  = simulate_game_for_screen(
            vis_gid, home_gid, lines, known_gids, xml_cache,
            n_games=args.n_games, weighting=args.weighting,
            nsim=args.nsim, kelly=kelly, markets=["ml","spread","total"],
            game_label=f"{vis_disp} @ {home_disp}",
        )
        if bets:
            all_bets = sorted(bets, key=lambda b: b["edge"], reverse=True)
            print(f"\n  {'Market':<8} {'Side':<24} {'Model':>7} {'Book':>7} {'Edge':>7} {'Kelly':>8}")
            print(f"  {'─'*7} {'─'*23} {'─'*7} {'─'*7} {'─'*7} {'─'*8}")
            for b in all_bets:
                edge_c = "+" if b["edge"] > 0 else ""
                print(f"  {b['market']:<8} {b['side']:<24} "
                      f"{b['model_prob']*100:>6.1f}% "
                      f"{b['book_implied']*100:>6.1f}% "
                      f"{b['edge']*100:>+6.1f}% "
                      f"{b['kelly']*100:>7.2f}%")
        else:
            print("\n  No positive-edge bets found for this matchup.")
        return
