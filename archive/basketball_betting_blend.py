...
# Keyed on lowercase ESPN abbreviation. Add rows here when new mismatches appear.
# Source of truth — takes priority over name matching and the confirmed cache.
ESPN_ABBR_TO_GID: dict[str, str] = {
    ...
    # Big 12
    "kan":"kan","ksu":"ksu","bay":"bay","tcu":"tcu","tex":"tex",
    "ttu":"text","wvu":"wvir","cin":"cinn","ucf":"ucf","iast":"iast",
    "okst":"okst","okla":"okla","byu":"byu","utah":"utah","colo":"colo",
    "az":"ariz","asu":"asu","hou":"hou",
    # Big Ten
    "msu":"msu","mich":"mich","osu":"osu","ind":"ind","pur":"pur",
    "ill":"ill","minn":"minn","iowa":"iowa","wis":"wisc","nw":"nw",
    "neb":"neb","md":"md","psu":"psu","rutg":"rutu","ucla":"ucla",
    "usc":"usc","ore":"ore","wsh":"wash","wash":"wash",
    # Big East
    "nova":"nova","uconn":"conn","marq":"marq","seha":"seha",
    "sjun":"stjo","depa":"depa","prov":"prov","crei":"crei",
    "but":"but1","xav":"xavi",
    # SEC
    "uk":"kty","tam":"tam","lsu":"lsu","aub":"aub","ala":"ala",
    "fla":"fla","uga":"ugeo","tenn":"tenn","van":"vand","scar":"scar",
    "mizz":"missou","msst":"msst","ark":"ark","ole":"ole",
    # A-Sun
    "lip":"lips","fgcu":"fgcu","stet":"stet","apsu":"apsu",
    "bell":"bell","njit":"njit","ken":"ken","qc":"qcon",
    # Big South / CAA / NEC
    "win":"wint","chso":"cso","pres":"pres","rad":"rad",
    "hpu":"hpu","gard":"gard","camp":"camp","hamp":"hamp",
    "lngw":"lngw","unca":"unca","uncw":"uncw","ne":"ne",
    "shu":"shun","sfpa":"sfpa",
    # SoCon
    "chat":"chat","cit":"cit","vmi":"vmi","uncg":"uncg",
    "woff":"woff","elon":"elon","mer":"mery","fur":"fur","samf":"sams",
    # MVC
    "brad":"brad","val":"valp","drke":"drak","belm":"belm",
    "uni":"uni","ilst":"ilst","evan":"evansv","most":"most","siu":"siu",
    "loy":"loychi",
    # MAC
    ...
    "m-oh":"mioh","ohio":"ohio",
    # A-10
    "dayt":"dayt","vcu":"vcu","duq":"duq","ford":"ford","gmu":"gmas",
    "gwu":"gwu","umass":"mass","uri":"rhod","rich":"rich",
    # MAAC
    "fair":"fair","stp":"stp","mrmk":"mrmk","iona":"iona",
    "manh":"manh","monk":"monk","niag":"niag","rider":"rider","sien":"siena",
    # OVC
    "tnst":"tnst","utm":"utm","semo":"semo","morh":"morh","murr":"murr",
    "uic":"uic",
    # Summit
    "oma":"oma","sdak":"sdak","ndak":"ndak","denv":"denv",
    # Ivy
    "harv":"harv","penn":"penn","colu":"colu","brow":"brow",
    "corn":"corn","dart":"dart","yale":"yale","prin":"prin",
    # Sun Belt
    "txst":"txst","usm":"smiss","usa":"usa","gso":"gsou","gsou":"gsou",
    "app":"app","troy":"troy","arst":"arst","ulm":"ulm","ccar":"ccar",
    # WCC / WAC / West
    "gonz":"gonz","sdsu":"sdsu","unlv":"unlv","fres":"fres",
    "port":"port","seu":"seatu","sdieg":"sdieg","seu":"seatu",
    # CUSA / misc
    "ncat":"ncat","nccu":"nccu","wgeo":"wgeo","quc":"quc","stj":"stjo",
    # Commonly mismatched — explicit overrides
    "char":"cso",       # Charleston Southern (not Charlotte)
    "cark":"cark",      # Central Arkansas
    "bell":"bellar",    # Bellarmine (not Belmont)
    "gard":"gard",      # Gardner-Webb
    "ston":"ston",      # Stonehill (if it appears; not Charleston Southern)
}
...
def odds_team_to_gid(team_name: str, known_gids: list[str],
    ...
    if not interactive:
        log.warning(f"  No mapping for '{team_name}' (key='{key}') — add to ESPN_ABBR_TO_GID")
        return None
