...
| `trainer.py` | `KalmanVAETrainer` | Training loop + latent history |

## Quick Start

```python
from goalpost.kalman_vae import TransitionEncoder, KalmanFilterImpl, TransitionDecoder, KalmanVAETrainer
...
# Inference
from goalpost.kalman_vae import MatchupPredictorImpl

predictor = MatchupPredictorImpl(decoder, mixer="average")
